...
async def get_top_products(
    ...
    if not es_service.client or not es_service.available:
        logger.warning("Elasticsearch não está disponível para a operação get_top_products")
        return {
            "success": False,
            "data": [],
...
async def get_price_evolution(
    ...
    # Verifica se o Elasticsearch está disponível
    if not es_service.client or not es_service.available:
        logger.warning("Elasticsearch não está disponível para a operação get_price_evolution")
        return {
            "success": False,
            "data": [],
            "message": "Serviço de busca temporariamente indisponível. Tente novamente mais tarde."
    ...
    try:
        ...
        return {
            "success": False,
            "data": [],
            "message": f"Erro ao buscar evolução de preço: {str(e)}"
        }
...
async def get_price_distribution(
    ...
    # Verifica se o Elasticsearch está disponível
    if not es_service.client or not es_service.available:
        logger.warning("Elasticsearch não está disponível para a operação get_price_distribution")
        return {
            "success": False,
            "data": [],
            "message": "Serviço de busca temporariamente indisponível. Tente novamente mais tarde."
    ...
    try:
        ...
        return {
            "success": False,
            "data": [],
            "message": f"Erro ao buscar distribuição de preços: {str(e)}"
        }
...
async def get_top_rated_products(
    ...
    # Verifica se o Elasticsearch está disponível
    if not es_service.client or not es_service.available:
        logger.warning("Elasticsearch não está disponível para a operação get_top_rated_products")
        return {
            "success": False,
            "data": [],
            "message": "Serviço de busca temporariamente indisponível. Tente novamente mais tarde."
    ...
    try:
        ...
        return {
            "success": False,
            "data": [],
            "message": f"Erro ao buscar produtos melhor avaliados: {str(e)}"
        }
